...
def quickSort2(array):
    return array if len(array) <= 1 else quickSort2([lt for lt in array[1:] if lt < array[0]]) + array[0:1] + \
                                         quickSort2([ge for ge in array[1:] if ge >= array[0]])
...
if __name__ == '__main__':
    ...
    print("List quick sort is:", result)
